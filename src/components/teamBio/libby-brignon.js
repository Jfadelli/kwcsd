        ...
        <div class="bio-content">
            <div className="bio-header">
                <section className="bio-card">
                    <a href="mailto:ebrignon@kwcommercial.com"><img className="headshot" alt="headhshot of Libby Brignon" src={Libby} /></a>
                    <h2>Elizabeth Brignon</h2>
                    <p>619-540-4208</p>
                    <a className="bio-email" href="mailto:ebrignon@kwcommercial.com">ebrignon@kwcommercial.com</a>
                </section>
                <a href="https://www.loopnet.com/brokerdirectory/profile/elizabeth-brignon/3jgrjrd">
                    <img className="bio-prop-photo" alt="link to a loopnet listing" src="https://images1.loopnet.com/i2/vrr4DgyNhPKdBj2AOitNdXYg6ja8S0tMCtxbPo3jgkI/112/image.jpg"></img></a>
            </div>
