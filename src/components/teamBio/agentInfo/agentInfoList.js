...
export const Agent = {
    ...
    //     phone: '',
    //     email: '',
    //     specialization: '', // e.g., "Land", "Industrial | Office", leave empty for "Generalist"
    //     loopnetLink:'',
    //     loopnetListingImage:'',
    ...
    MarkHughes: {
        ...
        specialization: 'Team Lead | Generalist',
    ...
    SueNa: {
        ...
        specialization: 'Flex/Industrial | Multi Unit | Retail',
    ...
    WillSchneider: {
        ...
        specialization: 'Industrial | Multi-Family | Office',
    ...
    PeterKim: {
        ...
        specialization: '', // Will display as "Generalist"
        kwEmail: '',
