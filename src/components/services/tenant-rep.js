        ...
        <div className={classes.flexCol}>
            ...
            <div className={classes.content}>
                <section className={classes.p}>
                    ...
                    <p>While some brokers work for both Landlords and Tenants in a transaction, we will fight for just one side: the Tenant.</p>
                </section>
                <section className={classes.p}>
                    <h3 className={classes.subHeading}>Benefits of Tenant Representation:</h3>
                    <section className={classes.list}>
                        <li>If you are not represented by your own agent, the Landlord knows this and negotiates to their benefit, not yours.</li>
                        ...
                        <li>Representation offers the opportunity to lower your effective rent through superior market knowledge.</li>
                    ...
                    <section className={classes.list}>
                        <h3 className={classes.subHeading}>We work with tenants to help…</h3>
