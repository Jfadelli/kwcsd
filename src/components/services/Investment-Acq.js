            ...
            <div className={classes.flexCol}>
                ...
                <div className={classes.content}>
                    <section className={classes.p}>
                        ...
                        <p>In addition to investment brokerage, we offer consulting services in development, financial analysis and finance. Our Investment Services team has over 35 years experience, which covers all of the above criteria essential to providing our clients with the highest quality representation available. </p><br/>
                        <p>Nationally, KW Commercial's Investment Property Directors and Associates keep abreast of the latest trends and fluctuations in equity and debt markets, as well as local and national CAP rates and market trends. Our vast network of international, private and institutional investors, allows us to match our clients who are open to investments beyond Southern California, with the investment opportunity that will maximize their returns, factoring in their risk tolerance. </p><br/>
